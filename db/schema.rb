...
ActiveRecord::Schema[8.0].define(version: 2025_04_30_104346) do
  ...
  create_table "listening_histories", force: :cascade do |t|
    ...
    t.index ["music_id"], name: "index_listening_histories_on_music_id"
  ...
  add_foreign_key "listening_histories", "musics"
